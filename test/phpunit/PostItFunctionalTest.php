...
/**
 * \file    test/phpunit/PostItFunctionalTest.php
 * \ingroup postit
 ...
 * @package Testpostit
 */
class PostItFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/postit/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('postit/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/postit/admin/about.php');
		$this->authenticate();
		return $this->assertContains('postit/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('postitwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPostIt_PostItTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPostIt_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
